'''
Unit test for the monkey_trouble function for [this Coding Bat Problem](https://codingbat.com/prob/p120546)
'''
...
def describe_a_monkey_trouble_function():
  ...
  def that_determines_whether_or_not_we_are_in_trouble():
    '''
    There are two monkeys who may or may not be smiling. If both
